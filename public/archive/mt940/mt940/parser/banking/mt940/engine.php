...
class Engine_mt940_banking_parser {
	...
	/**
	 * @param unsanitized account $string
	 * @return string
	 */
	...
	/**
	 * @param unsanitized accountname $string
	 * @return string
	 */
	...
	/**
	 * @param unsanitized date/datetime $string
	 * @return int
	 */
	function _sanitizeTimestamp($string, $inFormat = 'ymd') {
		//return (int) unDate($string, $inFormat, 'U');
	}

	/**
	 * @param unsanitized descriptin $string
	 * @return string
	 */
	...
	/**
	 * @param unsanitized debit/credit $string
	 * @return string
	 */
	...
	/**
	 * @param unsanitized price $string
	 * @return float
	 */
